...
const NAVIGATION_SECTIONS = [
   ...
   },
   {
      title: "Informations",
      items: [
         { id: "about", label: "À propos", path: "novytools/pages/about.html" },
         { id: "privacy", label: "Politique de confidentialité", path: "novytools/pages/privacy.html" },
         { id: "legal", label: "Mentions légales", path: "novytools/pages/legal.html" }
      ]
   }
];
